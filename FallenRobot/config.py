class Config(object):
    ...
    TIME_API_KEY = "<font style="vertical-align: inherit;"><font style="vertical-align: inherit;">http://api.timezonedb.com/v2.1/get-time-zone</font></font>"  # Get this value from https://timezonedb.com/api
